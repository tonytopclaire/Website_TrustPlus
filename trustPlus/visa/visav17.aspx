<%@ Page Language="C#" MasterPageFile="~/deSub.Master" AutoEventWireup="true" CodeBehind="visav17.aspx.cs" Inherits="trustPlus.visa.visav17" %>
...
NOC(C/D), 1.3.7.8.9类 （申请人至少为雇主工作一年）</li>
           ...
           NOC (B/C/D) CLB 4，雅思听4.5分、说4.0分、读3.5分、写4.0分；</li>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="t01">
